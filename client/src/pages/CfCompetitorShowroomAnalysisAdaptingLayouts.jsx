...
// Feature: Competitor showroom analysis adapting layouts
...
export default function CfCompetitorShowroomAnalysisAdaptingLayouts() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-competitor-showroom-analysis-adapting-layouts/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-competitor-showroom-analysis-adapting-layouts', project: 'AIVirtualShowroomBuilder' })
      })
  ...
  const loadHistory = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/cf-competitor-showroom-analysis-adapting-layouts/history`, { headers: getHeaders() })
      const data = await res.json()
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Competitor showroom analysis adapting layouts</h1>
